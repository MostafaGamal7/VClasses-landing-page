...
export default function Button({
  ...
  const baseStyles = `font-medium transition-all shadow-md hover:shadow-lg cursor-pointer text-center`;
  
  const variants = {
    primary: 'bg-linear-to-t from-primary-hover to-primary text-white hover:from-primary-hover hover:to-primary',
